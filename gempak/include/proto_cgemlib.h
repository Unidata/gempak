 ...
 *				ctb_gfaHasCV				*
 * L. Hinson/AWC        09/09   Add ctb_gfapCombineMtnObscTypes()       *
 * L. Hinson/AWC        09/09   Add ctb_gfhrAndUTC()                    *
 * S. Jacobs/NCEP	 3/10	Add cvg_openj				*
 ***********************************************************************/
...
void ctb_gfapCombineMtnObscTypes ( const char *inType0, 
				const char *inType1, 
				char *outType, 
				int *iret );
...
void    ctb_gfagfhrAndUTC ( char   *sep,
                         char   *cycle,
                         int    *nfhr,
                         char   *fhrlist,
                         int    *iret );
