 ...
 * L. Hinson/AWC        04/09   add GFA_SIGMET_ICE, GFA_SIGMET_TURB,    *
 *                              GFA_SIGMET_TURB, GFA_SIGMET_DS,         *
 *                              GFA_SIGMET_SS, GFA_SIGMET_VASH          *
...
#define GFA_SIGMET_ICE          (20 )
#define GFA_SIGMET_TURB         (21 )
#define GFA_SIGMET_DS           (22 )
#define GFA_SIGMET_SS           (23 )
#define GFA_SIGMET_VASH         (24 )
#define GFA_HAZARD_CLD_TOPS     (25 )
