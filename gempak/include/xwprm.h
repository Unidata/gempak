 ...
 * S. Jacobs/NCEP	 9/10	Changed DEFAULT_WNAME to remove version	*
 * S. Jacobs/NCEP	 9/10	Increased MAX_PIXMAP 136 -> 496		*
 ***********************************************************************/
...
#define MAX_PIXMAP      496 /* 480 + MAX_LOOP - maximum # of pixmaps in one window */

#define DEFAULT_WNAME   "GEMPAK" /* default window name */
