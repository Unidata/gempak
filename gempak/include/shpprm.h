...
#define MAP_NPSA (MAP_CNTY<<13)         /* Predictive Service Areas*/
#define MAP_UNDF (MAP_CNTY<<14)         /* Maps other that defined */
...
#define NPSABNDS        "npsabnds.tbl" 
#define NPSABNDS_INFO   "npsabnds.tbl.info"
#define NPSATBL         "npsa.tbl" 
 ...
 */
#define MAXFLD 32	/* Maximum number of fields per record */
			/* MAXFLD works best if a multiple of 8 */
#define MAXOUT 75000	/* Maximum numer of points per part */
#define MAXRECLEN 2000	/* Maximum record length */
