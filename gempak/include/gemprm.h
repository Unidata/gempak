 ...
 * m.gamazaychikov/CWS	01/10	Added IA2DBGINI, IA2DBNIDS, IA2DBMCID,  *
 *				IA2DBMOSA				*
 * X. Guo/CWS		04/10   Added RADAR uncompressed block size     * 
 * X. Guo/CWS		05/10   Added IFHINIDS and changed uncompressed	*
 *                              buffer size                             *
...
#define	MMFILE	(    8 )	/* Maximum # of open files */
...
/*---------------------------------------------------------------------*/
#if defined(IRIX) || defined(OSF1) || defined(ULTRIX) || defined (Darwin)
...
#define	LLMDGG		(1000000000)	/* Max mem for intern grids */
#define	LLMXGD		( 5000000 )	/* Max # grid points */
...
#define	LLMXPT		(  100000 )	/* Max # lines, polygons, ... */
#define	LLMXST		(      20 )	/* Max # stations in list */
#define	LLMXTG		(100000000 )	/* Ultimate max # grid points */
...
#define IFNEX2		(  8 )  /* NEXRAD Level II */
#define	IA2DBGINI	(  9 )	/* A2DB sat GINI image */
#define	IA2DBNIDS	( 10 )	/* A2DB radar NIDS image */
#define	IA2DBMOSA	( 11 )	/* A2DB radar MOSAIC image */
#define	IA2DBMCID	( 12 )	/* A2DB sat MCIDAS image */
#define IFHINIDS	( 13 )  /* Nexrad Higher Resolution NIDS format   */
/*---------------------------------------------------------------------*/
...
/*  Macro definitions */
/* S. Chiswell/Unidata Added for systems that don't provide MAX and MIN macros */
#ifndef MAX
 ...
 */
#define MAX_UNCOMPRESS_BLOCK    500000
#define RAD_IMG_HDR_LEN         18
#define RAD_IMG_PRD_DESC_LEN    102
#define RAD_IMG_UNCOMPRESS_LEN  (RAD_IMG_HDR_LEN + RAD_IMG_PRD_DESC_LEN)
#define RAD_IMG_COMPRESS_POS    (RAD_IMG_HDR_LEN + RAD_IMG_PRD_DESC_LEN)
