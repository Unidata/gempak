...
#define SIGTYP_LINE_HIGH 1
#define SIGTYP_LINE_MED  2
...
typedef struct ccfinfo {
    ...
    float	spd;		/* speed				*/
    float	dir;		/* direction				*/
    float       textlat;        /* Text box Latitude                    */
    float       textlon;        /* Text box Longitude                   */
    float       arrowlat;       /* Arrow Connector Lat                  */
    float       arrowlon;       /* Arrow Connector Lon                  */
    int         fillhi;         /* High fill                            */
    int         fillmed;        /* Med fill                             */
    int         filllow;        /* Low fill                             */
...
typedef struct ccftype {
    CCFInfo	info;
    SptxType    spt;                  /* Special Text Attributes              */
