 ...
 * R. McTaggart-Cowan    1/05   Added csgrab_ csfree_ and cssleep       * 
 ...
 * S. Chiswell/Unidata   4/05   im_rqnm, im_rqpe for netcdf QPE         *
 ...
 * m.gamazaychikov/CWS  01/10   Add db_gsathdr, db_radhdr, tb_nidsdb	*
 * X. Guo/CWS		04/10   Added im_nexbz function                 *
 * X. Guo/CWS           04/10   Added im_nexbzwmo function              *
 * S. Jacobs/NCEP	 6/10	Added gg_rtrk				*
 * m.gamazaychikov/CWS  04/11   Add db_open, db_rdtr, db_getstinfo, 	*
 *				db_getcycle, db_getparm, db_getduri, 	*
 *				db_getgnav, db_gtim			*
...
#define csfree          csfree_
#define csgrab          csgrab_
#define cssleep         cssleep_
...
#define im_nexbz	im_nexbz_
#define im_nexbzwmo     im_nexbzwmo_
...
#define inc_pccftxt     inc_pccftxt_
...
#define pd_hans		pd_hans_
#define pd_heat		pd_heat_
#define pd_inmm		pd_inmm_
#define pd_kinx		pd_kinx_
#define pd_knms		pd_knms_
#define pd_mixr		pd_mixr_
#define pd_mmin		pd_mmin_
#define pd_mskn		pd_mskn_
#define pd_plcl		pd_plcl_
#define pd_prcp		pd_prcp_
#define pd_prcr		pd_prcr_
#define pd_relh		pd_relh_
#define pd_reli		pd_reli_
#define pd_rhdp		pd_rhdp_
...
#define pd_thwc		pd_thwc_
#define pd_tlcl		pd_tlcl_
#define pd_tmcf		pd_tmcf_
#define pd_tmck		pd_tmck_
#define pd_tmfc		pd_tmfc_
#define pd_tmfk		pd_tmfk_
#define pd_tmkc		pd_tmkc_
#define pd_tmkf		pd_tmkf_
#define pd_tmpk		pd_tmpk_
#define pd_tmst		pd_tmst_
#define pd_tmwb		pd_tmwb_
#define pd_totl		pd_totl_
#define pd_tvrk		pd_tvrk_
#define pd_uvsd		pd_uvsd_
#define pd_vpmr		pd_vpmr_
#define pd_vtot		pd_vtot_
