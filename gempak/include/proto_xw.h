 ...
 * m.gamazaychikov/CWS	01/10	Added crginidb, crmosadb, crmcidasdb, 	*
 *				crnidsdb prototypes			*
 * X. Guo/CWS		04/10   Added crnexbz prototype                 *
 ***********************************************************************/
...
void 	crginidb ( 	char		*imgnam,
			int		*iret );

void	crmcidasdb (	char            *imgnam, 
                        int             *iret );

void 	crmosadb ( 	char 		*imgnam, 
			int 		*iret );

void 	crnidsdb ( 	char 		*imgnam, 
			int 		*iret );

void 	crncdf ( 	char		*imgnam,
			int		*iret );

void 	crnexbz ( 	char		*imgnam,
			int		*iret );
