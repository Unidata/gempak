 ...
 * L. Hinson/AWC        07/09   Added cds_ccftxt                        *
...
void    cds_ccftxt (    VG_DBStruct     const *el, 
                        VG_DBStruct     *txt_el, 
                        int             *iret);
...
void	cvg_rdjele ( 	VG_DBStruct	*el,
			int		start,
			int		numbytes,
			FILE		*fp,
			int		*iret );

void	cvg_rdjhdr ( 	char		*fname,
			FILE		*fp,
			int		start,
			int		size,
			VG_DBStruct	*el,
