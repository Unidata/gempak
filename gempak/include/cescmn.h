...
typedef struct
{
    int         fillhi;                 /* Fill Pattern for Hi Confidence */
    int         fillmed;                /* Fill Pattern for Med Confidence */
    int         filllow;                /* Fill Pattern for Low Confidence */
    int         linetype;               /* Line Type */
    float       szarrow;                /* Arrow Size for Connector */
    SpTextInfo  info;                   /* Special Text Info */
    char        textLayout[256];        /* Text Layout String */
} CcfAttr;
