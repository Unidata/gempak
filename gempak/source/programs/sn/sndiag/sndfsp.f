	SUBROUTINE SNDFSP  ( xx, yy, np, iend, c, iret )
C************************************************************************
C* SNDFSP								*
C*									*
...
C*									*
C* SNDFSP  ( XX, YY, NP, IEND, C, IRET )				*
C*									*
C* Input parameters:							*
C*	XX (NP)		REAL		X data positions		*
C*	YY (NP)		REAL		Y data positions		*
...
C**									*
C* Log:									*
C* S. Jacobs/SSAI	 4/92		Copied from GCFSPL		*
