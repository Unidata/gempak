	SUBROUTINE SNHDAT  ( iflno, dattim, respnd, newfil, datcur,
     +			     ntime, times, iret )
C************************************************************************
C* SNHDAT								*
C*									*
...
C*									*
C* SNHDAT  ( IFLNO, DATTIM, RESPND, NEWFIL, DATCUR, NTIME, TIMES,	*
C*           IRET )							*
C*									*
C* Input parameters:							*
C*	IFLNO		INTEGER		Sounding file number		*
C*	DATTIM		CHAR*		Date/time input			*
C*	RESPND		LOGICAL		Response flag			*
...
C**									*
C* Log:									*
C* G. Huffman/USRA	 8/89		Copy of SNPDAT			*
C* T. Piper/SAIC	 4/02	Fixed UMR; increased timfil & tout	*
C************************************************************************
	INCLUDE		'GEMPRM.PRM'
C*
