...
void ww_dcod ( char *curtim, char *gemfil, char *stntbl, char *prmfil, 
 ...
 * DCWTCH								*
 *									*
 * This program decodes WWUS40 watch reports and WWUS8 status reports   *
 * and writes the output to an ASCII file.                              *
 *									*
 *  Command line:							*
 ...
 * Log:									*
 * D. Kidwell/NCEP	 5/99                                           *
 * D. Kidwell/NCEP	 7/99	Changed prologue, WWUS9 -> WWUS40       *
 * D. Kidwell/NCEP	 8/99	Changed prologue, added WWUS8           *
...
**	this decoder because it uses the anchor station table and
...
*/
	...
	ww_dcod ( curtim, gemfil, stntbl, prmfil, 
