...
void ws_dcod ( char *curtim, char *gemfil, char *stntbl, char *prmfil,
 ...
 * DCWSTM								*
 *									*
 * This program decodes winter storm reports and writes the output to 	*
 * an ASCII file.                                                       *
 *									*
 *  Command line:							*
 *  dcwstm [options] filename						*
...
*/
	ws_dcod ( curtim, gemfil, stntbl, prmfil, 
