...
void wo_dcod ( char *curtim, char *gemfil, char *stntbl, char *prmfil,
 ...
 * DCWOU								*
 *									*
 * This program decodes watch outline update reports and writes the     *
 * output to an ASCII file.                                             *
 *									*
 *  Command line:							*
 *  dcwou [options] filename						*
...
*/
	wo_dcod ( curtim, gemfil, stntbl, prmfil, 
