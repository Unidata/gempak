 ...
 */
/* $Id: gdes.c,v 1.12 1996/01/10 16:22:02 russ Exp $ */
    ...
    gds *gdsp;
{
	...
	break;
    case GRID_RLL:
    case 201: /*Arakawa semi-staggered E grid on rotated Lat/lon grid */
	nerrs = fill_rll(&gdsp->grid.rll, ret);
        break;
    case 203: /*Arakawa semi-staggered E grid on rotated Lat/lon grid, extra points */
	nerrs = fill_rll(&gdsp->grid.rll, ret);
        break;
    case GRID_SLL:
