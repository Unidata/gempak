...
void ls_dcod ( char *curtim, char *gemfil, char *stntbl, char *prmfil, 
 ...
 * DCLSFC								*
 *									*
 * This program decodes land surface synoptic reports and writes the	*
 * output to a GEMPAK surface file.					*
 *									*
 *  Command line:							*
 *  dclsfc [options] filename						*
 *	filename	output file name/template			*
 **									*
 * Log:									*
 * D. Kidwell/NCEP	 1/98	Based on DCMSFC                         *
...
#define NUMEXP 1
	...
	char	*defprm = "lsfc.pack";
	char	*defstn = "lsfstns.tbl";
	char	*dfstn2 = " ";
	int	idfadd  = 0;
	int	idfmax  =  24;
	int	ndfhr1  =  5;
...
*/
	...
	ls_dcod ( curtim, gemfil, stntbl, prmfil, 
