...
void mt_dcod ( char *curtim, char *gemfil, char *stntbl, char *prmfil, 
 ...
 * DCMETR								*
 *									*
 * This program decodes metar reports and writes the output to a 	*
 * GEMPAK surface file.							*
 *									*
 *  Command line:							*
 *  dcmetr [options] filename						*
 *	filename	output file name/template			*
 **									*
 * Log:									*
 * K. Tyle/GSC		 9/96	Based on DCHRLY				*
 * D. Kidwell/NCEP 	 4/98	Removed bufr/nco references             *
...
#define NUMEXP 1
	...
	char	*defprm = "metar.pack";
	char	*defstn = "sfstns.tbl";
	char	*dfstn2 = " ";
	int	idfadd  = 25;
	int	idfmax  = 24;
	int	ndfhr1  =  5;
...
*/
	...
	mt_dcod ( curtim, gemfil, stntbl, prmfil, 
