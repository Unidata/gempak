...
void sv_dcod ( char *curtim, char *gemfil, char *stntbl, char *prmfil, 
 ...
 * DCSVRL								*
 *									*
 * This program decodes WWUS6[1-5] and WWUS32 severe local storm	*
 * (tornado and severe thunderstorm) watch reports and writes the	*
 * output to an ASCII file.						*
 *									*
 *  Command line:							*
 *  dcsvrl [options] filename						*
...
*/
	...
	sv_dcod ( curtim, gemfil, stntbl, prmfil, 
