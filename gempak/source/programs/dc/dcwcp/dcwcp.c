...
void wp_dcod ( char *curtim, char *gemfil, char *stntbl, char *prmfil, 
 ...
 * DCWCP								*
 *									*
 * This program decodes WWUS60 reports and writes the output to an	*
 * ASCII file.                     					*
 *									*
 *  Command line:							*
 *  dcwcp [options] filename						*
...
*/
	...
	wp_dcod ( curtim, gemfil, stntbl, prmfil, 
