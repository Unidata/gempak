 ...
 * DCWATCH								*
 *									*
 * This program decodes WWUS40 watch box bulletins			*
 *									*
 *  Command line:							*
 *  dcwatch [options] filename						*
 *      filename        output file name/template                       *
 **									*
 * Log:									*
 * Chiz/Unidata		8/96	Created from watchtogem			*
 ***********************************************************************/
...
#define NUMEXP	1
	...
	char	*defprm = "watch.pack";
	char	*defstn = "sfworld.tbl";
	char	*dfstn2 = " ";
	int	idfadd  = 0;
	int	idfmax  = 1500;
	int	ndfhr1  = 0;
...
*/
#ifdef UNDERSCORE
#define dcwwdc	dcwwdc_
#endif
        dcwwdc(gemfil, prmfil, &idfmax, curtim, stntbl, &iret, 
