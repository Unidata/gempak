...
void wc_dcod ( char *curtim, char *gemfil, char *stntbl, char *prmfil,
 ...
 * DCWCN								*
 *									*
 * This program decodes watch county notification reports and writes    *
 * the output to an ASCII file.                                         *
 *									*
 *  Command line:							*
 *  DCWCN [options] filename						*
 *	filename	output file name/template			*
 **									*
 * Log:									*
 * A. Hardy/NCEP	10/02						*
 * A. Hardy/NCEP	 3/04	Changed county.tbl to mzcntys.tbl	*
 * m.gamazaychikov/SAIC 07/05   Added parameters to CS of dc_gopt       *
 * H. Zeng/SAIC		08/05	Added parametes to CS of dc_gopt	*
...
*/
	wc_dcod ( curtim, gemfil, stntbl, prmfil, 
