...
void am_dcod ( char *curtim, char *gemfil, char *stntbl, char *prmfil,
 ...
 * DCAIRM								*
 *									*
 * This program decodes airmet reports and writes the output to an      *
 * ASCII file.                                                          *
 *									*
 *  Command line:							*
 *  dcairm [options] filename						*
...
*/
	...
	am_dcod ( curtim, gemfil, stntbl, prmfil, 
