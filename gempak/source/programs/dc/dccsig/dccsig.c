...
void cs_dcod ( char *curtim, char *gemfil, char *stntbl, char *prmfil,
 ...
 * DCCSIG								*
 *									*
 * This program decodes convective sigmet and convective outlook reports*
 * and writes the output to an ASCII file.                              *
 *									*
 *  Command line:							*
 *  dccsig [options] filename						*
 *	filename	output file name/template			*
 **									*
 * Log:									*
 * A. Hardy/NCEP 	 8/02 Created					*
...
*/
	...
	cs_dcod ( curtim, gemfil, stntbl, prmfil, 
