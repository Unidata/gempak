...
void wn_dcod ( char *curtim, char *gemfil, char *stntbl, char *prmfil, 
 ...
 * DCWARN								*
 *									*
 * This program decodes tornado, thunderstorm and flash flood warning   *
 * reports and writes the output to an ASCII file.                      *
 *									*
 *  Command line:							*
...
*/
	...
	wn_dcod ( curtim, gemfil, stntbl, prmfil, 
