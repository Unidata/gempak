...
void sc_dcod ( char *curtim, char *gemfil, char *stntbl, char *prmfil, 
 ...
 * DCSCD								*
 *									*
 * This program decodes SCD reports and writes the output to a 		*
 * GEMPAK surface file.							*
 *									*
 *  Command line:							*
 *  dcscd [options] filename						*
 *	filename	output file name/template			*
 **									*
 * Log:									*
 * K. Tyle/GSC		 2/97	Based on DCMETR				*
 * A. Hardy/GSC		12/97   Deleted bufrtb and ncoflg statements    *
...
#define NUMEXP 1
	...
	char	*defprm = "scd.pack";
	char	*defstn = "scdstn.tbl";
	char	*dfstn2 = " ";
	int	idfadd  = 25;
	int	idfmax  = 24;
	int	ndfhr1  =  5;
...
*/
	...
	sc_dcod ( curtim, gemfil, stntbl, prmfil, 
