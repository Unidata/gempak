	SUBROUTINE GDPCLA  ( gfunc, lflag, iret )
C************************************************************************
C* GDPCLA								*
C*									*
...
C* D. McCann/NSSFC	 12/94		added 'EPV(', 'WSHR', and 'BVSQ'*
C************************************************************************
C*
	CHARACTER*(*)	gfunc
	LOGICAL		lflag
C*
	CHARACTER	pfunc*256, parms(14)*4
	DATA parms / 'LAV(', 'LDF(', 'MASS', 'MDIV', 'MSDV', 'PVOR',
     +		   'RICH', 'STAB', 'LTRN', 'VLAV', 'VLDF', 'EPV(', 
     +             'WSHR', 'BVSQ' /
C------------------------------------------------------------------------
	iret = 0
	lflag = .false.
