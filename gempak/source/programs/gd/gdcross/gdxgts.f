	SUBROUTINE GDXGTS  ( time, ivcord, rgx, rgy, nhxs, 
...
C*									*
C* GDXGTS  ( TIME, IVCORD, RGX, RGY, NHXS, VCLSFC, HAVSFC, PARM, IRET ) *
C*									*
C* Input parameters:							*
...
C
	CALL DG_GRID ( gdtm, glev, parm, parm, pfunc, grid, igx, igy,
...
C
	    gvcd = 'NONE'
	    CALL DG_GRID ( gdtm, glev, gvcd, parm, pfunc, grid,
