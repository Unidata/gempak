	SUBROUTINE GDTXPL  ( border, iyplot, ystrt, ystop, vclsfc,
...
C*									*
C* GDTXPL  ( BORDER, IYPLOT, YSTRT, YSTOP, VCLSFC, HAVSFC, YLBL, NY,	*
...
C*					  0 = normal return		*
C*					 -8 = invalid vert coord type	*
C**									*
C* Log:									*
C* T.W.Barker/WR/SSD	 8/91	Created from gdxplt			*
C* K. Brill/NMC		11/92	Fix call to ER_WMSG			*
...
C
	...
	CALL GAAXIS  ( 1, ystrt, .true., ixlbfr, ixtmfr, ixglfr, nx,
     +		       xtlbl, ctlbl, ier )
	CALL GDAXIS  ( 3, ystop, .true., 000, ixtmfr, 000,0, nx, xtlbl,
     +		       ier )
