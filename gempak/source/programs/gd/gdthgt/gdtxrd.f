	SUBROUTINE GDTXRD ( time, gvcord, gfunc, levt, levb, lavflg,
     +			    rgx, rgy, inttyp, yy, iret)
C************************************************************************
C* GDTXRD								*
C*									*
C* This subroutine actually gets the data at a particular level		*
C*									*
C* GDTXRD ( TIME, GVCORD, GFUNC, LEVT, LEVB, LAVFLG, RGX, RGY, INTTYP,	*
C*	    YY, IRET)							*
C*									*
C* Input parameters:							*
...
C------------------------------------------------------------------------
	...
	CALL DG_GRID ( dualtm, glevel, gvcord, gfunc, pfunc, grid, kx,
