	SUBROUTINE G2T_A2RCEB ( ktype, lunb, nt, end, iret )
C************************************************************************
C* G2T_A2RCEB								*
C*									*
C* This subroutine creates G2T trending text, period A becoming RcEb.	*
C*									*
C* G2T_A2RCEB ( KTYPE, LUNB, NT, END, IRET )				*
C*									*
C* Input parameters:							*
...
C* T. Lee/SAIC		11/07	Added lesser values			*
...
C
	...
	nt2 = nt + 2
C
C*	Store RbEb in trending block 1, RcEc in block 2.
C
	itrnd = 2
...
C
C*	Replace Ec with Eb so block 2 becomes RcEb.  Reset the EXCEPTION
C*	and PORTION flags.
C
