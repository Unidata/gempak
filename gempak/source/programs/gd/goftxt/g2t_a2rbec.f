	SUBROUTINE G2T_A2RBEC ( ktype, lunb, nt, end, iret )
C************************************************************************
C* G2T_A2RBEC								*
C*									*
C* This subroutine creates G2T trending text, period A becoming RbEc.	*
C*									*
C* G2T_A2RBEC ( KTYPE, LUNB, NT, END, IRET )				*
C*									*
C* Input parameters:							*
...
C
	...
	nt2 = nt + 2
C
C*	Store RcEc in block trending 1, RbEb in 2.
C
	itrnd = 2
...
C
C*	Replace Eb with Ec so block 2 becomes RbEc.  Reset the EXCEPTION
C*	and PORTION flags.
C
