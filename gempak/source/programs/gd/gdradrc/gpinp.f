...
C*	  RADFRQ, CPYFIL, STNFIL, MAXGRD, NDVAL, IRET)			*
C**									*
C* Log:									*
C* Chiz/Unidata	 3/01	Developed from GPMAP				*
C************************************************************************
	CHARACTER*(*)	proj, gdarea, kxky, gdfile, radtim, ndval,
     +			raddur, radfrq, cpyfil, stnfil, maxgrd, gdpfun
C-----------------------------------------------------------------------
