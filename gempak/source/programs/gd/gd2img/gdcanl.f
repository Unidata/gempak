	SUBROUTINE GDCANL  ( anlyss, rnvblk, anlblk, iret )
C************************************************************************
C* GDCANL								*
C*									*
...
C*									*
C* GDCANL  ( ANLYSS, RNVBLK, ANLBLK, IRET )				*
C*									*
C* Input parameters:							*
...
C* Log:									*
C* K. Brill/GSC		 4/90						*
C* M. desJardins/NMC	 4/91	Rewrote calling GR_MBN2			*
C************************************************************************
	INCLUDE		'GEMPRM.PRM'
C*
	CHARACTER*(*)	anlyss
...
C
	CALL ST_ILST ( stusr (2), ';', 0, 4, iebnds, n, ier )
C
