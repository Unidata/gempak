 ...
 * center position.							*
 *                                                                      *
 * void aodtv72_runautomode ( fcsttype, fcstfile, imagefile, cenlat, 	*
 *			      cenlon, posm )                            *
 *                                                                      *
 * Input  parameters:                                                   *
...
/*---------------------------------------------------------------------*/
    	/*
     	 ...
     	 */
    	 iaodt=aodtv72_setforecastfile(fcstfile,fcsttype);  

    	/*
     	 * determine initial auto-center position estimate
	 */
    	 iaodt=aodtv72_runautomode1(&flat,&flon,&pos);

    	/*
     	 *   Set center location in AODT
     	 */
    	 iaodt=aodtv72_setlocation(flat,flon,pos);
	 ...
	 */
 	 iaodt=aodtv72_getwarmeyetemplocation(&wlat, &wlon);
	
	/*
	 * determine "best" automated position
	 */
	 iaodt=aodtv72_runautomode2(flat, flon, &tlat, &tlon, &tpos);
	 *cenlat = tlat;
	 *cenlon = tlon;
	 *posm   = tpos;
