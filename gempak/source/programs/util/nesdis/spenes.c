...
/*     strcat ( bufferfinal,"TTAA00 KNFD DDHHMM\n" ); */
    ...
    strcat ( bufferfinal,"SEE NCEP HPC DISCUSSION AND QPF/S FOR FORECAST.\n" );
    strcat ( bufferfinal,"....NESDIS IS A MEMBER OF 12 PLANET....\n" );
    strcat ( bufferfinal,".\n" );

    strcat ( bufferfinal,"SSD/SAB WEB ADDRESS FOR PRECIP ESTIMATES:\n" );
    strcat ( bufferfinal,"HTTP://WWW.SSD.NOAA.GOV/PS/PCPN/\n" );
    strcat ( bufferfinal,"...ALL LOWER CASE EXCEPT /PS/PCPN/\n" );
    strcat ( bufferfinal,".\n" );
