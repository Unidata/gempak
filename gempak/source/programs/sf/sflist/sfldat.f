	SUBROUTINE SFLDAT  ( iflno, dattim, newfil, datcur,
     +			     ntime, times, iret )
C************************************************************************
C* SFLDAT								*
C*									*
...
C*									*
C* SFLDAT  ( IFLNO, DATTIM, NEWFIL, DATCUR, NTIME, TIMES,		*
C*           IRET )							*
C*									*
C* Input parameters:							*
...
C* T. Piper/SAIC	 1/02	Increased timfil to 20 4 consistency	*
C************************************************************************
	INCLUDE		'GEMPRM.PRM'
C*
	...
	LOGICAL         newfil
C*
	CHARACTER	timfil (LLMXTM)*20, tout*15
C------------------------------------------------------------------------
	iret = 0
C
