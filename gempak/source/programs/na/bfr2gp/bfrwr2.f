	SUBROUTINE BFRWR2 ( lunsn, ihhmm, np, nz, sndata, iret )
C************************************************************************
C* BFRWR2								*
C*									*
...
C*									*
C* An unmerged sounding data file will be written.  LCAT will be checked*
...
C*									*
C*									*
C* BFRWR2 ( LUNSN, IHHMM, NP, NZ, SNDATA, IRET )			*
C*									*
C* Input parameters:							*
