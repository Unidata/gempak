	SUBROUTINE SNPDTW  ( ip1arr, ip2arr, iwncol, data, nlev, idtype,
     ...
     +                       wind, nwind, markers, xmin, xmax, iret )
C************************************************************************
C* SNPDTW								*
C*									*
