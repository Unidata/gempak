 ...
 * DCUSPLN								*
 *									*
 * This program decodes USPLN lightning reports and stores them in a	*
 *   GEMPAK ship file. 			                                *
 *									*
 *  Command line:							*
 *  dcispln [options] filename						*
 *      filename        output file name/template                       *
 **									*
 * Log:									*
 * Chiz/Unidata		10/06	Created 				*
 ***********************************************************************/
{
/*
...
*/
	decode_uspln (curtim, gemfil, prmfil, stntbl, maxtim,
		nhours, &iret);
