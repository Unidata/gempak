	SUBROUTINE SF_CRFP  ( filnam, prmfil, iflsrc, maxstn, maxtim, 
     +			      stmflg, isffln, nparm,  parms,  pkflg, 
     +			      iret )
C************************************************************************
C* SF_CRFP								*
C*									*
C* This subroutine creates a new standard surface data file.  The	*
C* file will have times stored as rows of the DM file and stations	*
C* as columns.								*
C*									*
...
C* subroutine is identical to SF_CREF except that the packing 		*
...
C*									*
C* SF_CRFP  ( FILNAM, PRMFIL, IFLSRC, MAXSTN, MAXTIM, STMFLG, ISFFLN, 	*
