...
void _prtPsSelectCb ( 	Widget, long which, XtPointer );
void _prtSizeSelectCb ( Widget, long which, XmToggleButtonCallbackStruct *cbs );
void _prtOrientSelectCb(Widget, long which, XmToggleButtonCallbackStruct *cbs );
void _prtColorSelectCb (Widget, long which, XmToggleButtonCallbackStruct *cbs );
void _prtPageSelectCb ( Widget, long which, XtPointer );
void _prtNameCb (       Widget, long which, XtPointer );
...
void NxmPrt_txtPrtCtlBtnCb ( Widget, XtPointer, XtPointer );
void NxmPrt_txtPrtDestroyCb( Widget, XtPointer, XtPointer );
...
/*=====================================================================*/
/* ARGSUSED */
void _prtSizeSelectCb ( Widget w, long which, XmToggleButtonCallbackStruct *cbs )
/************************************************************************
 * _prtSizeSelectCb							*
 *									*
 * This is the callbak function for size selection toggles		*
 *									*
 * void _prtSizeSelectCb(w, which, cbs)				*
 *									*
 * Input parameters:							*
 *	w	Widget		calling widget id			*
 *	which	long		index of selection			*
 *	cbs	XmToggleButtonCallbackStruct*	calling data		*
 *									*
 * Output parameters:							*
 * Return parameters:							*
 *			NONE						*
...
/*=====================================================================*/
/* ARGSUSED */
void _prtOrientSelectCb ( Widget w, long which,
 ...
 *									*
 * void _prtOrientSelectCb(w, which, cbs)				*
 *									*
 * Input parameters:							*
 *	w	Widget		calling widget id			*
 *	which	long		index of selection			*
...
/*=====================================================================*/
/* ARGSUSED */
void _prtColorSelectCb ( Widget w, long which,
			XmToggleButtonCallbackStruct *cbs )
/************************************************************************
 * _prtColorSelectCb							*
 *									*
 ...
 *									*
 * void _prtColorSelectCb(w, which, cbs)				*
 *									*
 * Input parameters:							*
 *	w	Widget		calling widget id			*
 *	which	long		index of selection			*
...
/*=====================================================================*/
/* ARGSUSED */
void _prtPageSelectCb ( Widget w, long which, XtPointer cbs )
 /***********************************************************************
 * _prtPageSelectCb							*
 *									*
 ...
 * selection toggles.							*
 *									*
 * void _prtPageSelectCb(w, which, cbs)				*
 *									*
 * Input parameters:							*
 *	w	Widget		calling widget id			*
 *	which	long		index of selection			*
...
/*=====================================================================*/
/* ARGSUSED */
void _prtNameCb ( Widget w, long which, XtPointer cbs )
/************************************************************************
 * _prtNameCb								*
 *									*
 * This is the printer name option menu callback function		*
 *									*
 * void _prtNameCb(w, which, cbs)					*
 *									*
 * Input parameters:							*
 *	w	Widget		calling widget id			*
 *	which	long		index of selection			*
 ...
 ***********************************************************************/
{
    ...
    _curPrtInx = (int)which;
    _prtSetDefault(_curPrtInx);
}

/*=====================================================================*/
/* ARGSUSED */
void _prtOkCb ( Widget w, XtPointer clnt, XtPointer cbs )
 /***********************************************************************
 * _prtOkCb								*
 *									*
 * This is the callback function for the OK control button		*
 *									*
 * void _prtOkCb(w, clnt, cbs) 						*
 *									*
 * Input parameters:							*
 *	w	Widget		calling widget id			*
...
/*=====================================================================*/
/* ARGSUSED */
void _prtCancelCb ( Widget w, XtPointer clnt, XtPointer cbs )
/************************************************************************
 * _prtCancelCb 							*
 *									*
 * This is the cancel button callback function				*
 *									*
 * void _prtCancelCb(w, clnt, cbs)					*
 *									*
 * Input parameters:							*
 *	w	Widget		calling widget id			*
 *	clnt	XtPointer	never used				*
...
/*=====================================================================*/
/* ARGSUSED */
void _prtHelpCb ( Widget w, XtPointer clnt, XtPointer cbs )
/************************************************************************
 * _prtHelpCb								*
 *									*
 * This is the callback function for HELP button			*
 *									*
 * void _prtHelpCb(w, clnt, cbs)					*
 *									*
 * Input parameters:							*
 *	w	Widget		calling widget id			*
 *	clnt	XtPointer	never used				*
...
/*=====================================================================*/
/* ARGSUSED */
void NxmPrt_txtPrtCtlBtnCb ( Widget wid, XtPointer fname, XtPointer cbs )
/************************************************************************
 ...
 * Selection window.							*
 *									*
 * void NxmPrt_txtPrtCtlBtnCb (wid, fname, cbs)			*
 *									*
 * Input parameters:							*
 *	wid	Widget		widget ID				*
 *	fname	XtPointer	pointer to text file name		*
 ...
 ***********************************************************************/
{
    ...
    XmSelectionBoxCallbackStruct* call_struct;
/*---------------------------------------------------------------------*/

    call_struct = (XmSelectionBoxCallbackStruct*)cbs;

    switch( call_struct->reason ) {

      case XmCR_OK:	  /* Print button */

        XmStringGetLtoR (call_struct->value, XmFONTLIST_DEFAULT_TAG, &ptext);
	...
	NxmWarn_show( wid, "Plase select a valid printer!" );
...
/*=====================================================================*/
/* ARGSUSED */
void NxmPrt_txtPrtDestroyCb ( Widget wid, XtPointer clnt, XtPointer cbs )
/************************************************************************
 * NxmPrt_txtPrtDestroyCb						*
 *									*
 * Callback function before Printer Selection window gets destroyed.	*
 *									*
 * void NxmPrt_txtPrtDestroyCb (wid, data, cbs)			*
 *									*
 * Input parameters:							*
 *	wid	Widget		widget ID				*
