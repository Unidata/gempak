        SUBROUTINE  MA_CLDS ( marrpt, lvl, ipt, iret )
C************************************************************************
C* MA_CLDS                                                              *
C*                                                                      *
...
C* D. Kidwell/NCEP     10/97	Cleaned up code and documentation       *
C* R. Hollern/NCEP      7/99	Added vertical visibility logic         *
C************************************************************************
        INCLUDE 	'GEMPRM.PRM'
        INCLUDE 	'macmn.cmn'
C*
     ...
     +           ( ival .ge. 0 .and. ival .le. 89 ) ) THEN
                ...
                IF ( ival .ge. 0 .and. ival .le. 50 ) THEN
                  ...
                  ELSE IF ( ival .eq. 89 ) THEN
                    xx = 22000.
                END IF
                IF ( marrpt ( ipt-2:ipt-2) .eq. '9' ) THEN
C
