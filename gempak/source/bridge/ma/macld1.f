        SUBROUTINE  MA_CLD1 ( marrpt, ipt, iret )
C************************************************************************
C* MA_CLD1                                                              *
C*                                                                      *
...
C* the three levels.                                                    *
C*                                                                      *
C* MA_CLD1  ( MARRPT, IPT, IRET )                                       *
C*                                                                      *
C* Input parameters:                                                    *
C*      MARRPT         	CHAR*           Report array                    *
C*      HGTLCL         	REAL            Height in hundreds of feet      *
...
C
		...
		rivals ( irctyl ) = FLOAT ( ival )
          ...
          ELSE
C
C*          Clouds are invisible owing to darkness, fog, etc.
C
            rivals ( ircltp ( 1 ) ) = 62.
        END IF
C
...
C
		...
		rivals ( irctym ) = FLOAT ( ival )
                ...
                IF ( marrpt (ipt:ipt) .ne. '0' .and. iflag .eq. 0 ) THEN
                    iflag = 1
