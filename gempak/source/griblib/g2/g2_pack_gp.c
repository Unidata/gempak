...
int g2_pack_gp(g2int *kfildo, g2int *ic, g2int *nxy, 
	g2int *is523, g2int *minpk, g2int *inc, g2int *missp, g2int 
	*misss, g2int *jmin, g2int *jmax, g2int *lbit, g2int *nov, 
	g2int *ndg, g2int *lx, g2int *ibit, g2int *jbit, g2int *
...
/*    *(unsigned char *)cfeed = (char) ifeed;  NOT used */
...
/*        FOR SPACE EFFICIENCY. */
    ...
    if (ired == 0) {
	g2_reduce(kfildo, &jmin[1], &jmax[1], &lbit[1], &nov[1], lx, ndg, ibit, 
