...
void gb_gmtx ( unsigned char *ptarray, int indx, int length, int *xgrid )
/************************************************************************
 * gb_gmtx								*
 *                                                                      *
 * This routine will read Grid data as a Matrix of values at each	*
 * point.								*
 *									*
 ...
 *	indx		int		Index into data buffer		*
