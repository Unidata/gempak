	SUBROUTINE GCBOXXF ( kx, ky, grid, ioffx, ioffy, iskip, nlvl, 
...
C* 									*
C* GCBOXXF ( KX, KY, GRID, IOFFX, IOFFY, ISKIP, NLVL, CLVL, ICOLR,	*
C*           LINTYP, LINWID, LINLBL, ZGRID, IRET )			*
C*									*
C* Input parameters:							*
C*									*
...
C
	CALL CADJST ( kx, ky, nlev, clev, zgrid, ier )
C
