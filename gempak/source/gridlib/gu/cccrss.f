	SUBROUTINE CCCRSS  ( ifrst, iscnd, i, j, cval, zgrid, iret )
C************************************************************************
C* CCCRSS								*
C*									*
...
C* corners.                                                             *
C*									*
C* CCCRSS  ( IFRST, ISCND, I, J, CVAL, ZGRID, IRET )			*
C*									*
C* Input parameters:							*
...
C* S. Gilbert/NCEP	 3/07	Added zgrid to call sequence            *
C************************************************************************
	INCLUDE		'GEMPRM.PRM'
 	INCLUDE		'CONTUR.CMN'
C*
