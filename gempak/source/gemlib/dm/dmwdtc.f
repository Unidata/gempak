	SUBROUTINE DM_WDTC ( iflno, irow, icol, part, idthdr, cdata, 
     +			     nchar, iret )
C************************************************************************
C* DM_WDTC								*
C*									*
C* This subroutine writes character data to a DM file.			*
C*									*
C* DM_WDTC  ( IFLNO, IROW, ICOL, PART, IDTHDR, CDATA, NCHAR, IRET )	*
C*									*
C* Input parameters:							*
...
C
	CALL DM_WSTR  ( iflno, isword, nchar, cdata, iret )
	IF  ( iret .ne. 0 )  RETURN
C
