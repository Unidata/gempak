...
int scandir ( const char *dirname, struct dirent ***, int (*)(const struct dirent *),
 ...
 * alphasort                                                            *
 *                                                                      *
 * This function sorts a list of directory entries alphabetically	*
 *                                                                      *
 * int alphasort ( d1, d2 )					        *
 *                                                                      *
 * Input parameters:                                                    *
 *      **d1		const struct dirent	Input directory list	*
 *									*
 * Output parameters:							*
 *	**d2		const struct dirent	Sorted directory list	*
 *      alphasort       int             Number of elements returned     *
 *                                                                      *
 **                                                                     *
 ***********************************************************************/
{
