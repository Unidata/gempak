...
C* R. McTaggart-Cowan/SUNY 01/05	Added SS_NWAIT			*
C************************************************************************
...
C-------------------------------------------------------------------------
	...
	DO WHILE  ( iostat .eq. 0 )
	    WRITE  (6,20)
20	    FORMAT 
     +     (' 1 = SS_CURS   2 = SS_EXIT   3 = SS_ENVR   4 = SS_WAIT'/, 
     +      ' 5 = SS_GSYM   6 = SS_VERS   7 = SS_PAGE   8 = SS_NWAIT' )
...
C------------------------------------------------------------------------
	    IF (numsub .eq. 1) THEN
		WRITE(6,*)' Enter line number'
	        READ (5,*) line
		CALL SS_CURS (line, iret)
