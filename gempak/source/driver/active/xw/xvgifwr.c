...
int WriteGIF ( FILE *fp, byte *pic, int w, int h, byte *rmap, 
 ...
 * output	                                                        *
 *                                                                      *
 * Output the given code to the file.					*
 * Assumptions:								*
 ...
 *                                                                      *
 * Input parameters:                                                    *
 *      code  	int	A n_bits-bit integer.  If == -1, then EOF.	*
