...
C* K. Brill/NMC		10/91	Change factor for bscalw to 1.3		*
C* M. desJardins/GSFC	12/91	GEMPAK 5.1 version			*
C* M. desJardins/NMC	 1/92	Added filflg; filflg			*
C* K. Brill/NMC		01/92	Set NNCOLR = 32				*
