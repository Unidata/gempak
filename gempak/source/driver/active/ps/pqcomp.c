...
void pqcomp ( int *index, char *clrnam, int *red, int *green, 
 ...
 * (if available).							*
 *									*
 * void pqcomp ( index, clrnam, red, green, blue, xname, clen, xlen,    *
 *								iret )	*
 *									*
 * Input parameters:							*
 ...
 * Log:									*
 * L. Williams/EAI	 2/96						*
 * S. Jacobs/NCEP	 4/96	Copied from the XW to the PS driver	*
 * T. Piper/SAIC	 7/03	Replaced xwcmn.h w/geminc.h & gemprm.h	*
 ***********************************************************************/
{
int	ctmp;
