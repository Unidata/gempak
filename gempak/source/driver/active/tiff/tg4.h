 ...
 * TG4.H								*
 *									*
 * This header file contains codes and definitions needed for the 	*
 ...
 * index into the table is known to be either the run
 * length, or (run length / 64) + a fixed offset.
 */
const tableentry whitecodes[] = {
    {  8, 0x35,    0 },	/* 0011 0101 */
    {  6, 0x07,    1 },	/* 0001 11 */
    {  4, 0x07,    2 },	/* 0111 */
    {  4, 0x08,    3 },	/* 1000 */
...
static const tableentry eolcode =
    { 12, 0x01, 0 };	/* 0000 0000 0001 */
