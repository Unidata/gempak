...
C* E. Wehner/EAi	 7/96	Adopted for raster driver		*
C* E. Wehner/EAi	10/96	Added pip scaling factors		*
C* E. Wehner/EAi	 1/97	Changed scaling factors			*
C* E. Wehner/EAi	 3/97	moved span calculation to hinita	*
C* S. Maxwell/GSC        6/97	Documentation changes                   *
C* S. Maxwell/GSC        6/97	Removed SAVRES		                *
C* S. Jacobs/NCEP	 6/97	Changed nlthw and nwdhw from HW to SW	*
C* S. Jacobs/NCEP	 7/97	Changed ntxhw, bscalc and bscalb	*
C* J. Whistler/AWC	 8/97	Update scaling factors			*
C* M. Linda/GSC		 8/97	Added bscall				*
C* S. Jacobs/NCEP	 1/98	Increased the value of lpscal		*
C* S. Jacobs/NCEP	 2/98	Fixed value for ntxhw			*
