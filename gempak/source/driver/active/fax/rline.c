...
void rline ( int *np, int ix[], int iy[], int *iret )
/************************************************************************
 * rline								*
 *									*
 * This subroutine draws lines to the raster image.			*
 *									*
 * void rline  ( np, ix, iy, iret )					*
 *									*
 * Input parameters:							*
 ...
 * E. Wehner/EAi	 3/97	Remove xsize/ysize in call to rbresn	*
 * S. Jacobs/NCEP	 6/97	Removed call to rdots			*
 ...
 * S. Jacobs/NCEP	 7/97	Recoded line algorithm			*
 ***********************************************************************/
{
