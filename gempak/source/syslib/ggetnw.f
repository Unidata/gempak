	SUBROUTINE GGETNW  ( idata, nw, iret )
C************************************************************************
C* GGETNW								*
C*									*
C* This subroutine gets part or all of a message.  This subroutine does	*
C* not wait for a message to be received.				*
C*									*
...
C**									*
C* Log:									*
C* J. Whistler/SSAI	12/91	Added NOWAIT to GGET			*
C************************************************************************
	INCLUDE		'ERROR.PRM'
	INCLUDE		'ADBUFF.CMN'
C*
...
C
	...
	END IF
C
C*	If no information was in mail box when checked, return.
C
	IF  ( iret .ne. 0 )  THEN
	    ntypsr = -1
	    RETURN  
