...
#define   NITEMS    8  		/* no. of elems. in structure + 
				   fxys (008007 & 008011) */
#define   TOPINFO   16          /* 1st 15 FXYs + 1 for number of groups */

void bfr_tur ( char *ofname, int numtur, turb_t *ptrb, int itime[], 
 ...
 * turbulence information into BUFR format.   				*
 *                                                                      *
 * bfr_tur ( ofname, numtur, ptrb, itime, jtime, nfxy, fxy_i, fxy_vals, *
 ...
 **                                                                     *
 * Log:                                                                 *
 * D. Kidwell/NCEP   9/03       From sigetur                            *
 * M. Li/SAIC       10/03       Changed call sequence                   *
 * M. Li/SAIC       11/03       Modified the comparion of fxy_vals      *
 * M. Li/SAIC	    01/04	Added a check for numtur		*
 * M. Li/SAIC	    04/04	Removed tur_fxy				*
...
/*---------------------------------------------------------------------*/
    ...
    /* 
     * Create a single array containing the TURB information.
     ...
     */
     ...
     if ( numtur == 0 ) {
         ...
         num_vals = ( tpts * 2 ) + ( numtur * NITEMS ) + TOPINFO;
     }
     ...
     */
     ...
     if ( numtur != 0 ) {
         ...
         for ( ii = 0; ii < numtur; ii++){
            ...
            /*
	     * Fill in base and top turbulence values.
	     */
