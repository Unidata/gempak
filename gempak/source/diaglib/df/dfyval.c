 ...
 * df_yval								*
 *									*
 * This subroutine returns the value of the y coordinate at each	*
...
{
    char cprj[5];
    int nrx, nry, nxy, kxyd, nval, kxd, kyd, ksub1, ksub2, i, j, indx,
        ier, zero;
...
/*----------------------------------------------------------------------*/
	...
	*iret = -16;
    ...
    kxyd = kxd * kyd;
    gtrans ( sys_G, sys_M, &kxyd, gnrx, gnry, gnxy, gnum, iret,
