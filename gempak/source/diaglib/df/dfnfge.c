 ...
 * df_nfge								*
 *									*
 * This subroutine computes NFGE (S,T,ROI), the neighborhood fractional *
 * coverage of a scalar field (S) greater than or equal to some         *
 ...
 ************************************************************************/
{
    ...
    float  gddx, gddy, gdspdx, gdspdy, radius, numberpts, thresh;
...
/*----------------------------------------------------------------------*/
    ...
    */
    ...
    /*
     * Loop over all grid points to determine neighborhood fractional coverage if threshold falls between rmin and rmax. 
     */
...
/* Calculate fractional coverage */
    ...
    /*
     * Make a name of the form 'NFGE'//S and update header;
     * update stack.
     */
    dg_updh ( "NFGE", &num, &num1, &num2, iret );
    dg_puts ( &num, iret );
