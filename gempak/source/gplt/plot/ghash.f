...
C* GHASH								*
C*									*
C* This subroutine plots hash marks in any coordinate system.  The      *
C* orientation is orthogonal to the given direction.  The hash          *
C* marks are drawn using attributes defined by GSHASH.			*
C*									*
...
C
	    CALL DHASH ( iwndw, num, gx, gy, gdir, iret )
C
	    ib = ie + 1
	END DO
C*
