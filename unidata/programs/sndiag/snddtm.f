	SUBROUTINE SNDDTM  ( iflno, dattim, newfil, datcur,
     +			     ntime, times, iret )
C************************************************************************
C* SNDDTM								*
C*									*
...
C*									*
C* SNDDTM  ( IFLNO, DATTIM, NEWFIL, DATCUR, NTIME, TIMES, IRET )	*
C*									*
C* Input parameters:							*
...
C**									*
C* Log:									*
C* S. Jacobs/SSAI	 4/92		Copied from SNLDAT		*
...
C*
	...
	LOGICAL         newfil
C*
	CHARACTER	timfil (LLMXTM)*15, tout*15
C------------------------------------------------------------------------
	iret = 0
C
