      SUBROUTINE UNPK_MERCATOR(KFILDO,IPACK,ND5,IS3,NS3,
...
C
C        PURPOSE
C            UNPACKS TEMPLATE 3.10, A MERCATOR MAP PROJECTION FROM
C            IN SECTION 3 OF A GRIB2 MESSAGE. 
...
C                       IS WRITTEN TO ELEMENTS 15 THROUGH 69
...
C
      ...
      IER=0
C
C        CHECK TO MAKE SURE THAT A MERCATOR PROJECTION
...
D    1           ' IS NOT MERCATOR. PLEASE REFER TO THE'/
...
C
C        UNPACK THE NUMBER POINTS ALONG A PARALLEL AND THE NUMBER
...
C
C        UNPACK THE LATITUDE AT WHICH THE MERCATOR PROJECTION
...
C        UNPACK THE SCANNING MODE.
      CALL UNPKBG(KFILDO,IPACK,ND5,LOCN,IPOS,IS3(60),8,N,IER,*900)
C
      IF(IAND(IS3(60),16).EQ.16)THEN
...
C        EQUATOR).
      CALL UNPKBG(KFILDO,IPACK,ND5,LOCN,IPOS,IS3(61),32,N,IER,*900)
C
C        UNPACK THE LONGITUDINAL AND LATITUDINAL DIRECTION GRID LENGTHS
      CALL UNPKBG(KFILDO,IPACK,ND5,LOCN,IPOS,IS3(65),32,N,IER,*900)
