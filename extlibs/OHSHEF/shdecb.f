...
C
C  use:     CALL SHDECB(KHAR,KHPOS,IREV,ICONT,QUO)
C
...
C  =====================================================================
      SUBROUTINE SHDECB(KHAR,KHPOS,IREV,ICONT,QUO)
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob5/rfc/ofs/src/shefpars_driv/RCS/shdecb.f,v $
     . $',                                                             '
     .$Id: shdecb.f,v 1.6 2000/03/17 19:58:12 dws Exp $
     . $' /
C    ===================================================================
C
