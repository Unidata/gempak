...
*/
{
  ...
  switch(value) {
    case -107: sprintf(strng,"Error creating output wind field analysis ascii file\n");
             break;
    case -108: sprintf(strng,"Error creating output wind field analysis ascii position file\n");
             break;
    ...
    case 81: sprintf(strng,"SST value of %4.1fC at cursor location\n",(float)intin/10.0);
             break;
    case 107: sprintf(strng,"WROTE OUTPUT WIND ANALYSIS GRID FILE grid%4.4d\n",intin);
             break;
