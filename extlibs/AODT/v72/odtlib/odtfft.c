...
int aodtv72_dfft(double [],double [],int);
double aodtv72_cmplx_abs( double, double );


int aodtv72_fft(float *cbd,float *dx2,int *idxcnt)
{
    int ixx,idxc,iok;
...
int aodtv72_dfft( double x[2], double y[2], int np )
{
double *px,*py;
