...
*/
{
  ...
  switch(value) {
    ...
    case -92: sprintf(strng,"Error with mouse button entry during scene override\n");
             break;
    case -101: sprintf(strng,"Error allocating memory for output wind field analysis GRID file\n");
             break;
    case -102: sprintf(strng,"Error opening output wind field analysis GRID file\n");
             break;
    case -103: sprintf(strng,"Error creating output wind field analysis GRID file\n");
             break;
    case -104: sprintf(strng,"Error writing to output wind field analysis GRID file\n");
             break;
    case -105: sprintf(strng,"Error closing output wind field analysis GRID file\n");
             break;
    ...
    case 102: sprintf(strng,"Successfully completed graph\n");
             break;
    case 106: sprintf(strng,"WROTE OUTPUT WIND ANALYSIS GRID FILE GRID%4.4d\n",intin);
             break;
