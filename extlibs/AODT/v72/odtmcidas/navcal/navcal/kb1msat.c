/* kb1msat.f -- translated by f2c (version 19990503).
...
#define metxxxmsatkb1_1 metxxxmsatkb1_

struct {
    char caltyp[4];
} brkpntmsatkb1_;

#define brkpntmsatkb1_1 brkpntmsatkb1_
...
integer kb1inimsat_(char *cin, char *cout, integer *iopt, ftnlen cin_len, 
	ftnlen cout_len)
{
...
/* local variables */
    ...
    /* Function Body */
    movw_(&c__5, &iopt[1], metxxxmsatkb1_1.jopt);
    metxxxmsatkb1_1.jtype = 0;
    metxxxmsatkb1_1.isou = iopt[1];
    metxxxmsatkb1_1.ides = iopt[2];
    if (s_cmp(cin, "RAW ", (ftnlen)4, (ftnlen)4) == 0 && s_cmp(cout, "RAD ", (
	    ftnlen)4, (ftnlen)4) == 0) {
	metxxxmsatkb1_1.jtype = 1;
    }
    if (s_cmp(cin, "RAW ", (ftnlen)4, (ftnlen)4) == 0 && s_cmp(cout, "TEMP", (
	    ftnlen)4, (ftnlen)4) == 0) {
	metxxxmsatkb1_1.jtype = 2;
    }
    if (s_cmp(cin, "RAW ", (ftnlen)4, (ftnlen)4) == 0 && s_cmp(cout, "BRIT", (
	    ftnlen)4, (ftnlen)4) == 0) {
	metxxxmsatkb1_1.jtype = 3;
    }
    if (s_cmp(cin, "RAW ", (ftnlen)4, (ftnlen)4) == 0 && s_cmp(cout, "MODB", (
	    ftnlen)4, (ftnlen)4) == 0) {
	metxxxmsatkb1_1.jtype = 3;
    }
    if (metxxxmsatkb1_1.jtype == 0) {
	goto L900;
    }
    ret_val = 0;
    return ret_val;
...
integer kb1calmsat_(integer *calb, integer *idir, integer *nval, integer *
	jband, integer *ibuf)
{
    /* Initialized data */
    ...
    extern integer grysclmsatkb1_(real *);
...
/* NOTE #D4F3= 54515 , #D4F4=54516 */
    ...
    if (lasara != idir[33] || metxxxmsatkb1_1.jtype != lastyp || lasbnd != 
	    iband) {
	lasbnd = iband;
	lasara = idir[33];
	lastyp = metxxxmsatkb1_1.jtype;
	if (iband != 8 && iband != 10) {
	    if (s_cmp(brkpntmsatkb1_1.caltyp, "BRIT", (ftnlen)4, (ftnlen)4) ==
		     0 || s_cmp(brkpntmsatkb1_1.caltyp, "RAW", (ftnlen)4, (
		    ftnlen)3) == 0) {
		for (j = 0; j <= 255; ++j) {
		    r__1 = (real) j;
...
/*  W */
	...
	if (s_cmp(brkpntmsatkb1_1.caltyp, "RAW", (ftnlen)4, (ftnlen)3) == 0 &&
		 metxxxmsatkb1_1.jtype == 3) {
...
/* L10: */
	...
	if (s_cmp(brkpntmsatkb1_1.caltyp, "RAD", (ftnlen)4, (ftnlen)3) == 0 &&
		 metxxxmsatkb1_1.jtype == 3) {
	    for (i__ = 0; i__ <= 255; ++i__) {
/* Computing MAX */
...
/* L30: */
	...
	for (i__ = 1; i__ <= 256; ++i__) {
	    if (s_cmp(brkpntmsatkb1_1.caltyp, "TEMP", (ftnlen)4, (ftnlen)4) ==
		     0 && metxxxmsatkb1_1.jtype == 3) {
...
/* L60: */
	...
	if (metxxxmsatkb1_1.jtype == 2) {
	    goto L150;
	}
	if (s_cmp(brkpntmsatkb1_1.caltyp, "TEMP", (ftnlen)4, (ftnlen)4) == 0 
		&& metxxxmsatkb1_1.jtype == 3) {
	    goto L150;
	}
	if (s_cmp(brkpntmsatkb1_1.caltyp, "BRIT", (ftnlen)4, (ftnlen)4) == 0 
		&& metxxxmsatkb1_1.jtype == 3) {
	    for (i__ = 1; i__ <= 256; ++i__) {
		r__2 = itable[i__ - 1] / 10.f;
		r__1 = (real) grysclmsatkb1_(&r__2);
		itable[i__ - 1] = brkval_(&r__1);
/* L70: */
	    }
	} else {
		...
		itable[i__ - 1] = grysclmsatkb1_(&r__1);
/* L80: */
	    }
	}
L150:
    ...
    mpixtb_(nval, &metxxxmsatkb1_1.isou, &metxxxmsatkb1_1.ides, &ibuf[1], 
	    itable);
    return ret_val;
} /* kb1calmsat_ */

integer kb1optmsat_(char *cfunc, integer *iin, integer *iout, ftnlen 
	cfunc_len)
{
    /* System generated locals */
    integer ret_val;
...
/* local variables */
	...
	if (ischar_(&iin[38]) == 1) {
	    ...
	    if (brkset_(cfile, brkpntmsatkb1_1.caltyp, (ftnlen)8, (ftnlen)4) 
		    != 0) {
		ret_val = -3;
		return ret_val;
	    }
	...
	if (brkset_(cfile, brkpntmsatkb1_1.caltyp, (ftnlen)8, (ftnlen)4) != 0)
		 {
	    ret_val = -3;
	    return ret_val;
	}
...
integer grysclmsatkb1_(real *tempk)
{
    /* Initialized data */
