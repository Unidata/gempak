...
/*  Error flag for byte size, conver */
	...
	edest_("Source (must be 1)=", &gmsxxgmskb3_1.isou, (ftnlen)19);
	edest_("Destination (must be 1,2, or 4)=", &gmsxxgmskb3_1.ides, (
		ftnlen)32);
    }
...
/*  Table Name in calibration data b */
	...
	edest_("     ...was ", &gmsxxgmskb3_1.kopt, (ftnlen)12);
	gmsxxgmskb3_1.kopt = 3;
	edest_("     ...reset to ", &gmsxxgmskb3_1.kopt, (ftnlen)17);
