/* nv1msgt.f -- translated by f2c (version 20031025).
...
#define msgmsgtnv1_1 msgmsgtnv1_

struct {
    integer loff, coff, lfac, cfac;
} nvparammsgtnv1_;

#define nvparammsgtnv1_1 nvparammsgtnv1_

integer nv1inimsgt_(integer *ifunc, integer *iparms)
{
	...
	nvparammsgtnv1_1.loff = iparms[2];
	nvparammsgtnv1_1.coff = iparms[3];
	nvparammsgtnv1_1.lfac = iparms[4];
	nvparammsgtnv1_1.cfac = iparms[5];
    } else if (*ifunc == 2) {
	clit_(ch__1, (ftnlen)4, &iparms[1]);
	if (i_indx(ch__1, "XY", (ftnlen)4, (ftnlen)2) != 0) {
	    msgmsgtnv1_1.itype = 1;
	}
	clit_(ch__1, (ftnlen)4, &iparms[1]);
	if (i_indx(ch__1, "LL", (ftnlen)4, (ftnlen)2) != 0) {
	    msgmsgtnv1_1.itype = 2;
	}
    }
    return ret_val;
} /* nv1inimsgt_ */

integer nv1saemsgt_(real *xlin, real *xele, real *xdum, real *xlat, real *
	xlon, real *z__)
{
    /* System generated locals */
    integer ret_val;
    ...
    /* Local variables */
    extern /* Subroutine */ int msg_to_llmsgtnv1__(real *, real *, real *, 
	    real *);
    static real a, b;
    ...
    msg_to_llmsgtnv1__(&r__1, &r__2, xlat, xlon);
    if (*xlat < -900.f) {
	ret_val = -1;
	return ret_val;
    }
    *xlon = -(*xlon);
    if (msgmsgtnv1_1.itype == 1) {
	a = *xlat;
	b = *xlon;
...
integer nv1easmsgt_(real *xlat, real *xlon, real *z__, real *xlin, real *xele,
	 real *xdum)
{
    /* System generated locals */
    integer ret_val;
    ...
    /* Local variables */
    extern /* Subroutine */ int ll_to_msgmsgtnv1__(real *, real *, real *, 
	    real *);
    static real a, b;
    ...
    ll_to_msgmsgtnv1__(&a, &b, xlin, xele);
    if (*xlin < 0.f) {
	ret_val = -1;
	return ret_val;
    }
...
integer nv1optmsgt_(integer *ifunc, real *xin, real *xout)
{
    /* System generated locals */
    integer ret_val;
    char ch__1[4];
...
/* Subroutine */ int ll_to_msgmsgtnv1__(real *xlat, real *xlon, real *xlin, 
	real *xele)
{
    /* Builtin functions */
...
/*       Subroutine assumes that line 1856.5 and element 1856.5 is 0/0 deg */
    ...
    deltax = 1.f / (nvparammsgtnv1_1.cfac / 1e6f);
    deltay = 1.f / (nvparammsgtnv1_1.lfac / 1e6f);
    xfi = *xlat * cdr;
    xla = *xlon * cdr;
	...
	*xele = -999.f;
    ...
    xr = px / deltax;
    yr = py / deltay;
    *xele = nvparammsgtnv1_1.coff / 10.f - xr;
    *xlin = nvparammsgtnv1_1.loff / 10.f - yr;
    *xele = 3713.f - *xele;
    *xlin = 3713.f - *xlin;
    return 0;
} /* ll_to_msgmsgtnv1__ */

/* Subroutine */ int msg_to_llmsgtnv1__(real *xlin, real *xele, real *xlat, 
	real *xlon)
{
    /* Builtin functions */
...
/*       Subroutine assumes that line 1856.5 and element 1856.5 is 0/0 deg */
    ...
    deltax = 1.f / (nvparammsgtnv1_1.cfac / 1e6f);
    deltay = 1.f / (nvparammsgtnv1_1.lfac / 1e6f);
    xr = *xele - nvparammsgtnv1_1.coff / 10.f;
    yr = *xlin - nvparammsgtnv1_1.loff / 10.f;
    xr = xr * deltax * cdr;
    yr = yr * deltay * cdr;
    tanx = tan(xr);
    tany = tan(yr);
