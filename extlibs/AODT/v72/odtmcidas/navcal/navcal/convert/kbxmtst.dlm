C Copyright(c) 2005, Space Science and Engineering Center, UW-Madison
C Refer to "McIDAS Software Acquisition and Distribution Policies"
C in the file  mcidas/data/license.txt

C *** $Id: kbxmtst.dlm,v 1.2 2005/07/06 18:10:54 tester3 Exp $ ***

C$ Name:
C$      kbxini - Calibration module for MTST data
C$
C$ Interface:
C$      integer function
...
C$
C$ Remarks:
C$      See remarks at subroutine RD_CAL for details of MTST Calibration Block.
...
c
      ...
      data fk1/9485.28809, 6888.16162, 38792.1172, 222569.438/
      data fk2/1333.62585, 1198.72144, 2132.70923, 3818.0271/
      data tc/0.341152728, 0.998827279,
     &        0.18731679,  0.999288201,
     &        0.380203456, 0.999109149,
     &        2.36744547,  0.996900678/
