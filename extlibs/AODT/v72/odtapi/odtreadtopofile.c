...
extern int aodtv72_readtopo( char *, float, float, int * );

int aodtv72_readtopofile( char *tfile, float lat, float lon, int *topo )
...
*/
{
  ...
  /* retstrng=(char *)calloc((size_t)100,(size_t)sizeof(char)); */
  iret=aodtv72_readtopo(tfile,lat,lon,&itopo);
