...
extern int aodtv72_automode2(float,float,float *,float *,int *);

int aodtv72_runautomode2(float flat,float flon,float *lat, float *lon,int *pos)
...
*/
{
  ...
  iok=aodtv72_automode2(flat,flon,&xlat,&xlon,&xpos);
  *lat=xlat;
  *lon=xlon;
  *pos=xpos;
