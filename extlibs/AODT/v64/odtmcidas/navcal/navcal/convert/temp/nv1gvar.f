     ...
     &   ELVINC,SCNINC,ELVLN,SCNPX,EWNOM,NSNOM                                  
      ...
      DOUBLE PRECISION  SW1   , CW1   , SW3   , CW3   , GATTgvarnv1             
     +                                                                          
      DOUBLE PRECISION  SUBLAT, SUBLON, SECS  , WA                              
      REAL              RPARMS(MXCDSZ)                                          
      DOUBLE PRECISION  IMGTIM, EPOCH , TIMEXgvarnv1                            
     + , TIME50gvarnv1                                                          
     +, R     , B(3,3)                                                          
      ...
      COMMON /GVRCOMgvarnv1/                                                    
     + ITYPE , INSTR , SUBLAT, SUBLON, IFLIP                                    
      COMMON /RADCOMgvarnv1/                                                    
     + AEC   , FERC  , AEBE2C, AEBE3C, AEBE4C                                   
      COMMON /SAVCOMgvarnv1/                                                    
     + B     , DR    , PHI                                                      
 ...
 4      INSTR = IPARMS(IMGSND)                                                  
     ...
     &         + RPARMS(DOY8)*SW1 + RPARMS(DOY9)*CW1                            
        ...
        IF (IMC.NE.0) THEN                                                      
          ...
          ROLL = ROLL + GATTgvarnv1                                             
     +(RAAWDS,RPARMS,IPARMS,WA,TE)                                              
                                                                                
          PITCH = PITCH + GATTgvarnv1                                           
     ...
     +(XLIN,XELE,XDUM,XLAT,XLON,Z)                                              
      ...
      REAL         YLAT  , YLON                                                 
      DOUBLE PRECISION   SUBLAT, SUBLON, EVLNgvarnv1                            
     +  , SCPXgvarnv1                                                           
     +  , TMPLAT, TMPLON                                                        
 ...
 900  CONTINUE                                                                  
	...
	ENDIF                                                                          
     ...
     &                                            *SCNINC(INSTR)                
      ...
      FUNCTION TIMEXgvarnv1                                                     
     +(NY,ND,NH,NM,S)                                                           
                                                                                
      IMPLICIT NONE                                                             
                                                                                
      INTEGER      ND    , NH    , NM    , J     , NY                           
      DOUBLE PRECISION       TIMEXgvarnv1                                       
     + , S                                                                      
     ...
     +(I)                                                                       
      ...
      DOUBLE PRECISION       TIME50gvarnv1                                      
     +, S                                                                       
     ...
     + = J * 1440.D0 + NH * 60.D0 + NM + S / 60.D0                              
      ...
      DOUBLE PRECISION FUNCTION GATTgvarnv1                                     
 ...
 20   CONTINUE                                                                  
     ...
     &   ELVINC,SCNINC,ELVLN,SCNPX,EWNOM,NSNOM                                  
      ...
      DOUBLE PRECISION FUNCTION EVLNgvarnv1                                     
     +(INSTR,RLINE)                                                             
     ...
     + = ELVMAX(INSTR) - (RLINE - 2.5) * ELVLN(INSTR)                           
      ...
      DOUBLE PRECISION FUNCTION SCPXgvarnv1                                     
     +(INSTR,PIX)                                                               
