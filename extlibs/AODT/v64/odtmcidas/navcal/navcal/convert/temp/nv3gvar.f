     ...
     &   ELVINC,SCNINC,ELVLN,SCNPX,EWNOM,NSNOM                                  
      ...
      DOUBLE PRECISION  SW1   , CW1   , SW3   , CW3   , GATTgvarnv3             
     +                                                                          
      DOUBLE PRECISION  SUBLAT, SUBLON, SECS  , WA                              
      REAL              RPARMS(MXCDSZ)                                          
      DOUBLE PRECISION  IMGTIM, EPOCH , TIMEXgvarnv3                            
     + , TIME50gvarnv3                                                          
     +, R     , B(3,3)                                                          
      ...
      COMMON /GVRCOMgvarnv3/                                                    
     + ITYPE , INSTR , SUBLAT, SUBLON, IFLIP                                    
      COMMON /RADCOMgvarnv3/                                                    
     + AEC   , FERC  , AEBE2C, AEBE3C, AEBE4C                                   
      COMMON /SAVCOMgvarnv3/                                                    
     + B     , DR    , PHI                                                      
 ...
 4      INSTR = IPARMS(IMGSND)                                                  
     ...
     &         + RPARMS(DOY8)*SW1 + RPARMS(DOY9)*CW1                            
        ...
        IF (IMC.NE.0) THEN                                                      
          ...
          ROLL = ROLL + GATTgvarnv3                                             
     +(RAAWDS,RPARMS,IPARMS,WA,TE)                                              
                                                                                
          PITCH = PITCH + GATTgvarnv3                                           
     ...
     +(XLIN,XELE,XDUM,XLAT,XLON,Z)                                              
      ...
      REAL         YLAT  , YLON                                                 
      DOUBLE PRECISION   SUBLAT, SUBLON, EVLNgvarnv3                            
     +  , SCPXgvarnv3                                                           
     +  , TMPLAT, TMPLON                                                        
 ...
 900  CONTINUE                                                                  
	...
	ENDIF                                                                          
     ...
     &                                            *SCNINC(INSTR)                
      ...
      FUNCTION TIMEXgvarnv3                                                     
     +(NY,ND,NH,NM,S)                                                           
                                                                                
      IMPLICIT NONE                                                             
                                                                                
      INTEGER      ND    , NH    , NM    , J     , NY                           
      DOUBLE PRECISION       TIMEXgvarnv3                                       
     + , S                                                                      
     ...
     +(I)                                                                       
      ...
      DOUBLE PRECISION       TIME50gvarnv3                                      
     +, S                                                                       
     ...
     + = J * 1440.D0 + NH * 60.D0 + NM + S / 60.D0                              
      ...
      DOUBLE PRECISION FUNCTION GATTgvarnv3                                     
 ...
 20   CONTINUE                                                                  
     ...
     &   ELVINC,SCNINC,ELVLN,SCNPX,EWNOM,NSNOM                                  
      ...
      DOUBLE PRECISION FUNCTION EVLNgvarnv3                                     
     +(INSTR,RLINE)                                                             
     ...
     + = ELVMAX(INSTR) - (RLINE - 2.5) * ELVLN(INSTR)                           
      ...
      DOUBLE PRECISION FUNCTION SCPXgvarnv3                                     
     +(INSTR,PIX)                                                               
