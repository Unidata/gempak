...
900   CONTINUE                                                                  
     ...
     + CALTYP                                                                   
      ...
      INTEGER IBAND,JBAND                                                       
      INTEGER CHKCODgvarkb2                                                     
     +                                                                          
      INTEGER BRKVAL                                                            
      INTEGER GRYSCLgvarkb2                                                     
     +                                                                          
      INTEGER CALB(*)                                                           
      INTEGER IDIR(*)                                                           
      INTEGER IOFF                                                              
 ...
 100  CALL MGVATB(NVAL,ISOU,IDES,IBUF,ITAB(1, INDX))                            
     ...
     *           0.2026000E+00, 0.9992000E+00/                                  
     ...
     + = FK1(KKCH,SATIDX)/EXPN                                                  
      ...
      INTEGER FUNCTION GRYSCLgvarkb2                                            
     + (TEMPK)                                                                  
...
200   CONTINUE                                                                  
     ...
     *              0.000000E+00/                                               
       ...
       IF(MOD(ISAT,2) .EQ. 0) THEN                                              
           DO 10 ITEMP=1,8                                                      
             IF(PCTDIFgvarkb2                                                   
     +(IVBIAS(ITEMP), FRMTgvarkb2                                               
     +(CODARR(CODPOS)))                                                         
     *            .GT. MXDF .AND. HVCOD .EQ. 1) THEN                            
               VISARR(NEWPOS) = FRMTgvarkb2                                     
     +(CODARR(CODPOS))                                                          
               IFLAG = 1                                                        
             ELSE                                                               
...
60       CONTINUE                                                               
     ...
     *             .GT. MXDF .AND. HVCOD .EQ. 1) THEN                           
     ...
     + = 0.                                                                     
       ...
       INTEGER FUNCTION CHKCODgvarkb2                                           
     +(IARR)                                                                    
