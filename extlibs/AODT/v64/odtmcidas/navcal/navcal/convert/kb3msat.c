/* kb3msat.f -- translated by f2c (version 19990503).
...
#define metxxxmsatkb3_1 metxxxmsatkb3_

struct {
    char caltyp[4];
} brkpntmsatkb3_;

#define brkpntmsatkb3_1 brkpntmsatkb3_
...
integer kb3inimsat_(char *cin, char *cout, integer *iopt, ftnlen cin_len, 
	ftnlen cout_len)
{
...
/* local variables */
    ...
    /* Function Body */
    movw_(&c__5, &iopt[1], metxxxmsatkb3_1.jopt);
    metxxxmsatkb3_1.jtype = 0;
    metxxxmsatkb3_1.isou = iopt[1];
    metxxxmsatkb3_1.ides = iopt[2];
    if (s_cmp(cin, "RAW ", (ftnlen)4, (ftnlen)4) == 0 && s_cmp(cout, "RAD ", (
	    ftnlen)4, (ftnlen)4) == 0) {
	metxxxmsatkb3_1.jtype = 1;
    }
    if (s_cmp(cin, "RAW ", (ftnlen)4, (ftnlen)4) == 0 && s_cmp(cout, "TEMP", (
	    ftnlen)4, (ftnlen)4) == 0) {
	metxxxmsatkb3_1.jtype = 2;
    }
...
integer kb3optmsat_(char *cfunc, integer *iin, integer *iout, ftnlen 
	cfunc_len)
{
    /* System generated locals */
    integer ret_val;
...
/* local variables */
	...
	if (ischar_(&iin[38]) == 1) {
	    ...
	    if (brkset_(cfile, brkpntmsatkb3_1.caltyp, (ftnlen)8, (ftnlen)4) 
		    != 0) {
		ret_val = -3;
		return ret_val;
	    }
	...
	if (brkset_(cfile, brkpntmsatkb3_1.caltyp, (ftnlen)8, (ftnlen)4) != 0)
		 {
	    ret_val = -3;
	    return ret_val;
	}
...
integer grysclmsatkb3_(real *tempk)
{
    /* Initialized data */
