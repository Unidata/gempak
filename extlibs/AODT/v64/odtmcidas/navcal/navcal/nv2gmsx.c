/* nv2gmsx.f -- translated by f2c (version 19990503).
...
#define gmsnavcomgmsxnv2_1 gmsnavcomgmsxnv2_
...
integer nv2saegmsx_(real *lin, real *ele, real *dum1, real *lat, real *lon, 
	real *z__)
{
    /* System generated locals */
    integer ret_val;
    ...
    *lon *= -1.f;
    ...
    if (gmsnavcomgmsxnv2_1.navtype == 1) {
	ylat = *lat;
	ylon = *lon;
...
integer nv2easgmsx_(real *inlat, real *inlon, real *z__, real *lin, real *ele,
	 real *dum1)
{
    /* System generated locals */
    integer ret_val;
...
integer icon1gmsxnv2_(integer *yymmdd)
{
    /* Initialized data */
...
/* Subroutine */ int nllxyzgmsxnv2_(real *xlat, real *xlon, real *x, real *y, 
	real *z__)
{
    /* System generated locals */
    real r__1;
...
/* Subroutine */ int nxyzllgmsxnv2_(real *x, real *y, real *z__, real *xlat, 
	real *xlon)
{
    /* Builtin functions */
