...
/*  Error flag for byte size, conver */
	...
	edestX_("Source (must be 1)=", &gmsxxgmskb2_1.isou, (ftnlen)19);
	edestX_("Destination (must be 1,2, or 4)=", &gmsxxgmskb2_1.ides, (
		ftnlen)32);
    }
...
/*  Table Name in calibration data b */
	...
	edestX_("     ...was ", &gmsxxgmskb2_1.kopt, (ftnlen)12);
	gmsxxgmskb2_1.kopt = 3;
	edestX_("     ...reset to ", &gmsxxgmskb2_1.kopt, (ftnlen)17);
