/* nv2rect.f -- translated by f2c (version 19990503).
...
#define rctcomrectnv2_1 rctcomrectnv2_
...
integer nv2saerect_(real *xlin, real *xele, real *xdum, real *xlat, real *
	xlon, real *z__)
{
    /* System generated locals */
    integer ret_val;
...
/* ,ULLON */
    xldif = rctcomrectnv2_1.xrow - *xlin;
    if (rctcomrectnv2_1.xcol == 1.f) {
	xedif = rctcomrectnv2_1.iwest * (*xele - rctcomrectnv2_1.xcol);
	*xlon = rctcomrectnv2_1.zslon + rctcomrectnv2_1.iwest * 180 - xedif * 
		rctcomrectnv2_1.zdlon;
    } else {
	xedif = rctcomrectnv2_1.iwest * (rctcomrectnv2_1.xcol - *xele);
	*xlon = rctcomrectnv2_1.zslon + xedif * rctcomrectnv2_1.zdlon;
    }
    *xlat = rctcomrectnv2_1.zslat + xldif * rctcomrectnv2_1.zdlat;
    if (*xlat > 90.f || *xlat < -90.f) {
	goto L900;
    }
    if (*xlon > rctcomrectnv2_1.zslon + 180.f) {
	goto L900;
    }
    if (*xlon < rctcomrectnv2_1.zslon - 180.f) {
	goto L900;
...
integer nv2easrect_(real *zlat, real *zlon, real *z__, real *xlin, real *xele,
	 real *xdum)
{
    /* System generated locals */
    integer ret_val;
...
/* ,ULLON */
    ...
    if (xlon > rctcomrectnv2_1.zslon + 180.f) {
	xlon += -360.f;
    } else if (xlon < rctcomrectnv2_1.zslon - 180.f) {
	xlon += 360.f;
    }
    *xlin = rctcomrectnv2_1.xrow - (xlat - rctcomrectnv2_1.zslat) / 
	    rctcomrectnv2_1.zdlat;
    if (rctcomrectnv2_1.xcol == 1.f) {
	*xele = rctcomrectnv2_1.xcol - (xlon - rctcomrectnv2_1.zslon - 
		rctcomrectnv2_1.iwest * 180.f) / (rctcomrectnv2_1.zdlon * 
		rctcomrectnv2_1.iwest);
    } else {
	*xele = rctcomrectnv2_1.xcol - (xlon - rctcomrectnv2_1.zslon) / (
		rctcomrectnv2_1.zdlon * rctcomrectnv2_1.iwest);
    }
    ret_val = 0;
    return ret_val;
} /* nv2easrect_ */
