/* nv1gmsx.f -- translated by f2c (version 19990503).
...
#define gmsnavcomgmsxnv1_1 gmsnavcomgmsxnv1_
...
integer nv1inigmsx_(integer *ifunc, integer *iparms)
{
...
/* L100: */
	...
	if (i_indx(ch__1, "XY", (ftnlen)4, (ftnlen)2) != 0) {
	    gmsnavcomgmsxnv1_1.navtype = 1;
	}
	clit_(ch__1, (ftnlen)4, &iparms[1]);
	if (i_indx(ch__1, "LL", (ftnlen)4, (ftnlen)2) != 0) {
	    gmsnavcomgmsxnv1_1.navtype = 2;
	}
    }
    ret_val = 0;
    return ret_val;
...
integer nv1saegmsx_(real *lin, real *ele, real *dum1, real *lat, real *lon, 
	real *z__)
{
    /* System generated locals */
    integer ret_val;
    ...
    *lon *= -1.f;
    ...
    if (gmsnavcomgmsxnv1_1.navtype == 1) {
	ylat = *lat;
	ylon = *lon;
...
integer nv1easgmsx_(real *inlat, real *inlon, real *z__, real *lin, real *ele,
	 real *dum1)
{
    /* System generated locals */
    integer ret_val;
...
integer nv1optgmsx_(integer *ifunc, real *xin, real *xout)
{
    /* System generated locals */
    integer ret_val;
    char ch__1[4];
    ...
    extern /* Character */ VOID clit_(char *, ftnlen, integer *);
    static char cfunc[4];
    extern /* Subroutine */ int sdestX_(char *, integer *, ftnlen);
	...
	sublatlon_(&xout[1]);
	sdestX_("IN NVX OPT USING --- SPOS", &c__0, (ftnlen)25);
    } else if (s_cmp(cfunc, "ANG ", (ftnlen)4, (ftnlen)4) == 0) {
	sdestX_("IN NVX OPT USING --- ANG ", &c__0, (ftnlen)25);
    } else if (s_cmp(cfunc, "HGT ", (ftnlen)4, (ftnlen)4) == 0) {
	sdestX_("IN NVX OPT USING --- HGT ", &c__0, (ftnlen)25);
    } else {
	ret_val = 1;
    }
    return ret_val;
...
integer icon1gmsxnv1_(integer *yymmdd)
{
    /* Initialized data */
...
/* Subroutine */ int nllxyzgmsxnv1_(real *xlat, real *xlon, real *x, real *y, 
	real *z__)
{
    /* System generated locals */
    real r__1;
...
/* Subroutine */ int nxyzllgmsxnv1_(real *x, real *y, real *z__, real *xlat, 
	real *xlon)
{
    /* Builtin functions */
