/*
 * EXAMPLE 19: Replication within a data set using mixed floating
...

{
   ...
   /* test for correct numbner of command line arguments */
    ...
    switch ( *argv[1]){
       case 'a':
          strcpy(fxy_file,"exam19a.fxy");
          strcpy(encode_file,"ex19a.enc");
          break;
       case 'b':
          strcpy(fxy_file,"exam19b.fxy");
          strcpy(encode_file,"ex19b.enc");
    }
...
*/
    for(i = 0; i < 3; i++){
      bufr_rec = (Data_MixVal_t *) malloc(sizeof(Data_MixVal_t) * 22);
