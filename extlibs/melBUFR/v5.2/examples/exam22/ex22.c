/*
 * EXAMPLE 22: Replication within a data set using mixed floating
 * point data and character strings.
 ...
 * wind direction, and station name.  Compress the data after it is encoded.
 */
...

{
   ...
   /* test for correct numbner of command line arguments */
    if ( argc != 2) {
      printf(" ********************************\n");
      printf("   To execute example22 enter \n");
      printf("  >ex22 [a,b]\n\n");
    ...
    switch ( *argv[1]){
     ...
     default:
         printf("\n  <<<<<< ERROR >>>>>>\n");
         printf(" ********************************\n");
         printf("   To execute example19 enter \n");
         printf("  >ex19 [a,b]\n\n");
         printf("  a = text string using descriptor 1011\n");
         printf("  b = text string using 02-05-009 to encode the string\n");
         printf(" ********************************\n");
    ...
    switch ( *argv[1]){
       case 'a':
          strcpy(fxy_file,"exam22a.fxy");
          strcpy(encode_file,"ex22a.enc");
          break;
       case 'b':
          strcpy(fxy_file,"exam22b.fxy");
          strcpy(encode_file,"ex22b.enc");
    }
