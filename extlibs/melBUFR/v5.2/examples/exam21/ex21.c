/*
 * EXAMPLE 21:Simple set of descriptors with no replication or other
 * Table C descriptiors and character strings and using compression.
 * The data set is composed of a latitude, longitude,
 * date, time, station ID.  After the data is replicated, it is
 * compressed.
 */
...

{
    ...
    strcpy(fxy_file,"exam21.fxy");
    strcpy(encode_file,"ex21.enc");
    /********************************************************/
    /*             read FXYs                                */
    /********************************************************/
