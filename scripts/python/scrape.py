...
#    print "!23|123|123|123|12345678901234567890123456789012|12345678901234567890|123456789012|12345|123456.89"
    for r in table.findAll('tr'):
      ...
      if ct>0: rl[0] = getUrlArgs(url)[0].zfill(3)  + " " + getUrlArgs(url)[1].zfill(3) + " " + rl[0].zfill(3) + " 000"
      if len(rl) > 1:
        if "Reserved" in rl[1]: rl[0] = '!' + rl[0]
        if "See Table" in rl[2] or "Code table" in rl[2]:  rl[2] ="cat"
